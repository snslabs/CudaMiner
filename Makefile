...
.cu.o:
	$(NVCC) -D_FORCE_INLINES  -g -O2 -Xptxas "-abi=yes -v" -arch=sm_37 --maxrregcount=64 --ptxas-options=-v $(JANSSON_INCLUDES) -o $@ -c $<
...
fermi_kernel.o: fermi_kernel.cu
	$(NVCC) -D_FORCE_INLINES  -g -O2 -Xptxas "-abi=yes -v" -arch=sm_37 --maxrregcount=64 $(JANSSON_INCLUDES) -o $@ -c $<

kepler_kernel.o: kepler_kernel.cu
	$(NVCC) -D_FORCE_INLINES  -g -O2 -Xptxas "-abi=yes -v" -arch=sm_37 --maxrregcount=32 $(JANSSON_INCLUDES) -o $@ -c $<
...
nv_kernel.o: nv_kernel.cu
	$(NVCC) -D_FORCE_INLINES  -g -O2 -Xptxas "-abi=yes -v" -arch=sm_37 --maxrregcount=63 $(JANSSON_INCLUDES) -o $@ -c $<

nv_kernel2.o: nv_kernel2.cu
	$(NVCC) -D_FORCE_INLINES  -g -O2 -Xptxas "-abi=yes -v" -arch=sm_37 --maxrregcount=80 $(JANSSON_INCLUDES) -o $@ -c $<
